    ...
    <div className="min-h-screen bg-[#f5f4f2] font-sans flex flex-col">
      ...
      <main className="flex flex-col items-center justify-center flex-1 px-6 pb-20">
        <div className="bg-white border border-black/10 rounded-xl p-8 w-full max-w-[420px]">
          <h1 className="text-[#7a0d0d] text-[28px] font-bold mb-1" style={{ fontFamily: "Georgia, serif" }}>Welcome back.</h1>
          <p className="text-[14px] text-gray-400 mb-8">Sign in to your ResumeBot account.</p>
          <div className="flex flex-col gap-4">
            ...
            <button onClick={handleSignIn} disabled={loading} className="w-full bg-[#7a0d0d] hover:bg-[#5e0909] disabled:opacity-60 text-white text-[15px] font-semibold py-4 rounded-lg transition-colors mt-2">
              {loading ? "Signing in..." : "Sign In"}
            </button>
          </div>
          <p className="text-[13px] text-gray-400 text-center mt-6">
            Don't have an account?{" "}
            <span onClick={() => navigate("/signup")} className="text-[#7a0d0d] underline cursor-pointer">Sign up</span>
          </p>
        </div>
      </main>
